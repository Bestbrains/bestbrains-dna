---
title: "What is Bestbrains?"
prev_section: index.html
next_section: how-bestbrains-works.html
---

h1. What is Bestbrains and why?

bq(bb-proposal). I propose that we create our own version of the A3, starting with a copy and then do incremental changes.
The same for the values; they could be ours, but we might want to change some to use our own terms.
_(bb-who)Morten_
...
*Bestbrains is a home for IT consultants who value:*
...
bq(bb-proposal). A new point:
* *Redundant* - We try to make ourselves redundant. The customer should only need us for a short period
_(bb-who)Bo_
