...
next_section: brainlets.html
---

h1. {{ site.company_name }} Hack Summit

{{ site.company_name }} Hack Summit is a 2-day event where we meet up at a off-site location and hack on pet projects and similar.
...
* get to know each other, and people who wish to join {{ site.company_name }}
* flee family chores ;)

h2. Why is it called {{ site.company_name }} Hack Summit?
