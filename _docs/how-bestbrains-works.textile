...
bq(bb-proposal). This page talks more about consensus, and less about the advice process. I propose that we change the lingo here to reflect that, since I think that the advice process should be our "most visible" decision process. I think the consensus thing with hand signals could work well for us when we are assembled, though, so I'd like us to test it out more.
_(bb-who)Morten_
