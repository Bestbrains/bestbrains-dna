...
* *Meritocracy & Consensus* - we don't have titles, managers, or reporting structures. Instead we trust each other to make good decisions. Decisions are made mostly using the advice process ("here's how":decisions.html).
