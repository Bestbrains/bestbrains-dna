...
h1. How {{ site.company_name }} works
...
We also have a ceiling, to limit the total fee a consultant pays to {{ site.company_name }} per year (variable + fixed). Some consultants earn a lot more than others and we don't want them to leave just because {{ site.company_name }} gets too expensive. The ceiling is usually around kDKK 250-300 per year.
...
* We are dedicated to {{ site.company_name }} - that is, consultants are expected to do all their work and invoicing through Crisp.
