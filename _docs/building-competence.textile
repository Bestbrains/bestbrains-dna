...
* RD - a meetup where someone presents something interesting that they've learned recently (see above). Here's a page in Swedish which lists the "topics Crisp talked about from 2002-2012":https://www.crisp.se/om-crisp/crisp-internutbildning
* GDWC - Get Drunk With Crisp - a pub night that happens from time to time
* Invite our favorite gurus and rock stars to come to Copenhagen and teach courses or co-train with us
...
* Write "articles":http://www.bestbrains.dk/blogs/tanker-fra-bestbrains/ -and "books":https://www.crisp.se/bocker-och-produkter (sometimes in pairs).-
* Create and teach "courses":https://academy.bestbrains.dk (gives the teacher a very strong motivation to learn the topic!)
