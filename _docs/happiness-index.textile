...
bq(bb-proposal). We have not had anything like this. I propose that we (when we get around to it) try it out and form our own opinion. (Knee-jerk: aren't we small enough that we don't need this?).
_(bb-who)Morten_
...
There's pretty strong peer pressure for people to update this, and most of us do. Some every month, others less frequently. But nobody is forced (remember one of our "core values":what-is-bestbrains.html is freedom, so nobody forces anyone to do anything). But all in all this gives us a great overview of what's working and what needs to be fixed.

bq. Jeff Sutherland saw this and got so excited that he wrote an article called "Happiness Metric - the wave of the future":http://www.scruminc.com/happiness-metric-wave-of-future and now "teaches webinars":http://www.scruminc.com/happiness_metric/ on it and talks about it all over the world. Cool :^)
