...
One big aha in the Crisp evolution was when they "realized":http://blog.crisp.se/2010/05/08/henrikkniberg/1273272420000 that Crisp itself is just a platform. Crisp doesn't have a Vision (with a Big V), we just want Crisp to be a "nice home for consultants":what-is-bestbrains.html. Same for {{ site.company_name }}.

However, many of the _people_ at {{ site.company_name }} do have a vision. Here are the most widely shared visions:
