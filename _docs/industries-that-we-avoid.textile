...
Our two "core values":what-is-bestbrains.html "Freedom" and "Heart over Wallet" can sometimes collide. For example when it comes to which industries we work in. Some Crispers feel very strongly against the arms industry and the surveillance industry - for them, "Heart over Wallet" means avoiding those industries even if it means a loss of profit, and they don't want to associate with a consulting company that works with these industries.
...
If you are _strongly_ against any specific industry, bring it up at the next "unconference":unconference.html (or better yet, before joining Crisp). The decision boils down to how much you hate that industry vs how much others love it :^)
