...
Bestrains has existed for 15 years, and after many years of experimenting we've converged on an operational model that works well, basically the sweet spot between being an independent consultant and being an employee. We found that a related company in Sweden, Crisp, operated in much the same way, and had decided to formulate and publish it as an open source recipy. Rather than define our own DNA from scratch, we decided to base the fine work of these people.


Want to start a similar org? See "How to clone the Bestbrains DNA":how-to-copy.html.
