...
{{ site.company_name }} has existed for 15 years, and after many years of experimenting we've converged on an operational model that works well, basically the sweet spot between being an independent consultant and being an employee. We found that a related company in Sweden, "Crisp AB":http://www.crisp.se, operated in much the same way, and had generously decided to formulate and publish it's model as an open source recipe.
