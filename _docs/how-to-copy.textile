...
h1. How to clone the Bestbrains DNA

The Bestbrains DNA is "open-source on github":https://github.com/wilstrup/bestbrains-dna, so you are welcome to copy it and create something similar. The DNA is itself a derivative of the "Crisp Open Source DNA":https://github.com/crispab/crisp-dna. Make sure you check out the original as well, to see if either one serves your purpose better.

h2. Why clone the Bestbrains DNA?
