...
We have an office team of 1 full-time, 1 part-time (Crisp 3 full-time) employee that are based in our office in Copenhagen, plus some extra staff that are pulled in when needed. The office team does most of the the non-consulting work needed to run the day to day operations.
...
In comparison, the other {{ site.company_members }} (the consultants) don't have salaries and don't need a manager. In a sense, the customers set the salaries of the consultants, so it's rather automatic.
