...
bq(bb-proposal). Should we adapt the Crisp aganda and open space or describe the 'versionsdage' and our trips abroad
Somehow it is very static to have papers like this describing the agena etc.
_(bb-who)Bo_

h1. Crisp Unconference

Twice per year we do an internal unconference, in Denmark or abroad.
...
Varies. We normally alternate between a small local trips (2 days at a venue near Copenhagen), followed by a bigger international trip (4 days in some interesting city, like Barcelona or Rome or Istanbul).
