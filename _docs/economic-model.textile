...
The high level economic model is summarized in "How {{ site.company_name }} Works":how-bestbrains-works.html. Here are some concrete examples to make it more clear.
...
Check "how {{ site.company_name }} works":how-bestbrains-works.html if you are curious about why we don't want {{ site.company_name }} to earn a big profit.
...
So anyone who wants to do risk-pooling is free to propose a model and see if anyone wants to join, but insurance isn't owned or managed by {{ site.company_name }}. Perfect case for a "{{ site.company_cell }}":brainlets.html.
