...
The high level economic model is summarized in "How Bestbrains Works":how-bestbrains-works.html. Here are some concrete examples to make it more clear.

h2. Example: One month

Suppose Joe is a Bestbrains consultant, and his current client is Innitech. Joe's consulting fee is €100 per hour. And suppose the current Bestbrains fee is 10% + €500/month.

# During January, Joe does 100 hours of work for Innitech.
# At the end of January, Joe adds one row to the invoicing spreadsheet (a single shared Google doc for everyone at Bestbrains), noting that Innitech should be invoiced €10,000 for January.
# The "office team":office-team.html sends a €10,000 invoice from Bestbrains to Innitech, for Joe's services.
# Joe sends a €9,000 invoice from his personal company to Bestbrains (€10,000 minus the 10% Bestbrains "tax").

*Result for January:*
Innitech pays €10,000, Joe earns €9,000, Bestbrains earns €1,000.

In addition, once per quarter Bestbrains will send a €1500 invoice to Joe's company (3 x €500, the monthly fixed fee).
...
* Bestbrains earned €12,000 from Joe's work at Innitech (10% of the income from Innitech)
* In addition, Joe paid €6000 to Bestbrains in fixed fees (€500 x 12 months)
* *Result for the year:*
** Innitech: -€120,000
** Joe: +€102,000
** Bestbrains: +€18,000
...
Suppose the Bestbrains fee ceiling is €20,000 per year.
...
That means Joe will pull in about €240,000, which means the Bestbrains fee would be €24,000. That's way past the €20,000 ceiling, and we haven't even taken the fixed €500/month into account. The point of having a ceiling is to make sure the cost of being at Bestbrains doesn't get out of hand for the highest paid consultants.

Joe tells the office team that he's most likely going to hit the ceiling this year, so there's no point bothering with the % fee. Instead, Joe keeps 100% of what he earns, and Bestbrains just invoices him the ceiling fee of €5000 per quarter (= €20,000 per year divided into 4 quarters). Simple.
...
At the end of the fiscal year, the "board":board.html notices that Bestbrains is accumulating too much money (we want to maintain a limited liquidity buffer and not build up piles of cash), so they lower the fee to 9% + €400/month, and lower the ceiling to €18,000/year. Yay!

Check "how Bestbrains works":how-bestbrains-works.html if you are curious about why we don't want Bestbrains to earn a big profit.

h2. What about taxes and VAT?

Taxes and VAT? Oh yes, that messes up the clean calculations above... :^)
...
In a "normal" consulting company, consultants get their salary every month and the employer needs to prepare for risks using things like cash buffers and insurances. But Bestbrains is more like a bunch of collaborating independents, and we leave it up to each individual to manage risk and insurance in their own company.

Nevertheless it may sound obvious that Bestbrains should provide a "rainy day insurance" for each consultant, a shared cash buffer to support a consultant who runs into sudden cash flow problems. But that money needs to come from somewhere, and will in one way or another cause the Bestbrains fee to increase.
...
* *Yes*: "An insurance will increase my freedom and security, because Bestbrains will help me if I run into temporary cash flow problems."
...
This is where our "explicitly stated core values":what-is-bestbrains.html come into use. Freedom is a core value, financial stability isn't. That doesn't mean financial stability isn't important, it just means that people came to Bestbrains primarily for freedom, and that includes the freedom to choose your own risk-management approach.
...
So anyone who wants to do risk-pooling is free to propose a model and see if anyone wants to join, but insurance isn't owned or managed by Bestbrains. Perfect case for a "Brainlet":brainlets.html.
